# Generated by Powerlevel10k configuration wizard on 2024-02-04 at 17:43 PST.
...
() {
  ...
  typeset -g          # todo items (https://github.com/todotxt/todo.txt-cli)
    # timewarrior             # timewarrior tracking status (https://timewarrior.net/)
    # taskwarrior             # taskwarrior task count (https://taskwarrior.org/)
    # per_directory POWERLEVEL9K_ICON_PADDING=none
